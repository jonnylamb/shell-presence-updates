# copied from http://cgit.collabora.com/git/user/bari/shell-message-notifier.git/tree/Makefile
# grazie Marco, sei troppo gentile!
...
dist:
	...
	rm -f shell-presence-updates.zip 2> /dev/null; \
	zip shell-presence-updates.zip $$dist_file ChangeLog; \
	rm ChangeLog
